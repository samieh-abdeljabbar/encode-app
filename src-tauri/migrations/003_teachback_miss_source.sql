-- Add 'teachback_miss' to cards.source_type CHECK constraint.
...
CREATE TABLE IF NOT EXISTS cards_new (
    ...
    source_type TEXT NOT NULL DEFAULT 'repair' CHECK(source_type IN ('repair', 'quiz_miss', 'manual', 'ai_suggest', 'teachback_miss')),
