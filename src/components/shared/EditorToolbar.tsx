...
export default function EditorToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-0.5 border-b border-border-subtle bg-panel px-4 py-2 shrink-0">
      {/* Undo / Redo */}
      ...
      <div className="relative">
        <button
          ...
          title="Insert table"
          className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-transparent text-text-muted transition-colors hover:border-border-strong hover:bg-panel-active hover:text-text"
        >
          <Table size={sz} />
        </button>
        {showTablePicker && (
