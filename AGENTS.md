# AGENTS.md — Development Instructions for Encode
...
**AI is tiered:** Ollama (local, free) is the default. Codex/Gemini API is optional for higher quality. No AI mode still works for reading, gates, and flashcards.
...
- **Codex** — POST to `api.anthropic.com/v1/messages` (best quality)
